...
class mainframe(Frame):
    ...
    #Frame for options
        ...
        option_lbl = Label(self.btn_frame, text = 'Options', font = 'Segeo 15', bg = 'maroon', fg = 'gold').grid(row = 0, column = 0, sticky = 'ew', columnspan = 4, pady = 10)
    #Options
        ...
        Button(master, text = "Display student List", font = "Segoe 14", relief = GROOVE, command =self.update_list,fg= "black", bg= 'gold', bd=0).grid(row = 5, column = 0, sticky = 'ew', columnspan= 7, padx = 7, pady = 7)
    ...
    #Labels and title
        self.title_label = Label(master, text = 'Student Information System', font = 'Segeo 35', bg = 'maroon', fg = 'Gold').grid(row = 0, column = 1,sticky = 'ew', columnspan= 5, padx = 7, pady = 7)
    ...
    def main(self):
        ...
        self.id_lbl = Label(self.stud_form,text = 'ID number :', fg = 'gold', font = 'Segeo 15', bg = 'maroon').grid(row = 2, column = 0, sticky = 'ew', padx = 3, pady = 3)
        self.name_lbl = Label(self.stud_form,text = 'Name :', fg = 'gold', font = 'Segeo 15', bg = 'maroon').grid(row = 3, column = 0, sticky = 'ew', padx = 3, pady = 3)
        self.course_lbl = Label(self.stud_form,text = 'Course :', fg = 'gold', font = 'Segeo 15', bg = 'maroon').grid(row = 4, column = 0, sticky = 'ew', padx = 3, pady = 3) 
        self.year_lbl = Label(self.stud_form,text = 'Year :', fg = 'gold', font = 'Segeo 15', bg = 'maroon').grid(row = 5, column = 0, sticky = 'ew', padx = 3, pady = 3)
        self.gender_lbl = Label(self.stud_form,text = 'Gender :', fg = 'gold', font = 'Segeo 15', bg = 'maroon').grid(row = 6, column = 0, sticky = 'ew', padx = 3, pady =3)
